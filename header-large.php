<?php
/**
 * The Header for the homepage, uses a larger header image & slidedeck
 *
	...
	<?php
		...
		*/
		...
		if($slidedeck_shortcode != '') {
			...
			?><?php echo do_shortcode('[SlideDeck2 id=42 ress=1 proportional=false]'); ?><?php
		}
		?>
	...
	<!-- Slidedeck short code-->
		...
		*/
		...
		if($cta_button !='') {
			...
			?><a href="/projects/" class="cta-link"><span class="cta-button">View Gallery</span></a><?php
		}
		?>
		</div>
		<!-- End CTA area -->
